(function() {
    ...
    function initPyNoteEmbeds() {
        const targets = document.querySelectorAll('pynote:not([data-initialized]), pre.pynote:not([data-initialized])');
        ...
        targets.forEach(target => {
            ...
            const initialContent = isTemplate ? cleanTemplateContent(target.textContent) : '';
            ...
            if (target.hasAttribute('data-disable-insert-all')) {
                config.disableInsertAll = target.getAttribute('data-disable-insert-all') === 'true';
            }
